...
# CONFIGURACIÓN
csv_path = "valores_pixeles_filtrados.csv"
plots_dir = "plots_pixeles_filtrados"
...
for banda in df["nombre_banda"].unique():
    ...
    plt.plot(sub["fecha"], sub["valor_filtrado"], label=banda)
    plt.xlabel("Fecha")
...
for banda in df["nombre_banda"].unique():
    ...
    sns.histplot(sub["valor_filtrado"], kde=True, color="blue")
...
print("\nTodos los gráficos fueron guardados en /plots_pixeles_filtrados")
